...
bot = Bot(token='8471399557:AAFc64Am10tFZg4Soxtf5PUs-e7WOFBPI6I')
dp = Dispatcher()
...
async def weather(message:Message):
    await message.reply_sticker(
        sticker='CAACAgIAAxkBAAMPaSfL5dXU-_WP6UGcnHlSAk2NdiQAAodWAAJqrXFLw2G_LcVtFgABNgQ'
    )
